...
const EvaluationsListPage = () => {
  ...
  const statusOptions = ["All", "Pending", "In review", "Completed", "Rejected"];
  ...
  return (
    <>
      ...
      <div className="p-6 min-h-screen" style={{ backgroundColor: "#0f172a" }}>
        ...
        <div className="mb-6 p-4 rounded-lg" style={{ backgroundColor: "#1e293b" }}>
          ...
          <div className="mt-4 text-gray-300">
            Showing <span className="font-bold text-white">{filteredEvaluations.length}</span> of{" "}
            <span className="font-bold text-white">{evaluations.length}</span> evaluations
          </div>
        </div>
              ...
              <thead>
                <tr style={{ backgroundColor: "#334155" }}>
                  ...
                  <th
                    ...
                    className="px-6 py-3 text-left font-semibold text-white border-b border-gray-600 cursor-pointer hover:bg-gray-700"
                  >
                    Candidate Name {sortBy === "candidate_name" && (sortOrder === "asc" ? "↑" : "↓")}
                  </th>
